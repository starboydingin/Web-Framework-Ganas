...
import useTheme from "../Components/useTheme"; // import hook theme

export default function LoginPage({ onNavigate, onLogin }) {
  const { theme, mounted } = useTheme(); // ambil theme dari Home
  ...
  const handleSubmit = (e) => {
    ...
    // Simulasi login (bisa diganti API)
    setTimeout(() => {
      setIsLoading(false);
      onLogin(email); // callback ke Home.jsx untuk pindah ke dashboard
    }, 1000);
  };
